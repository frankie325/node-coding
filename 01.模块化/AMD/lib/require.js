...
!(function (global, setTimeout) {
          ...
          if ((head || (head = e.parentNode), (dataMain = e.getAttribute('data-main'))))
            return (
              ...
              cfg.baseUrl ||
                ...
                ((mainScript = (src = mainScript.split('/')).pop()), (subPath = src.length ? src.join('/') + '/' : './'), (cfg.baseUrl = subPath)),
  ...
  function newContext(u) {
    ...
    function s(e) {
      ...
      return (
        o(t, l.onScriptLoad, 'load', 'onreadystatechange'), o(t, l.onScriptError, 'error'), { node: t, id: t && t.getAttribute('data-requiremodule') }
      );
    }
    function T() {
      var e;
          ...
          ((f[this.map.id] = this).enabled = !0),
            ...
            each(
              ...
              bind(this, function (e, t) {
                ...
                if ('string' == typeof e) {
                  if (
                    ((e = S(e, this.map.isDefine ? this.map : this.map.parentMap, !1, !this.skipMap)), (this.depMaps[t] = e), (n = getOwn(c, e.id)))
                  )
                ...
                ? isFunction(t)
                  ...
                  : ((r = S(e, o, !1, !0).id),
                    hasProp(m, r)
                      ? m[r]
                      : O(
                          makeError('notloaded', 'Module name "' + r + '" has not been loaded yet for context: ' + u + (o ? '' : '. Use require([])'))
                        ))
                : (T(),
                  l.nextTick(function () {
            ...
            mixin(s, {
              ...
              toUrl: function (e) {
                var t,
                  ...
                  r = e.split('/')[0];
                return (
                  -1 !== i && (!('.' === r || '..' === r) || 1 < i) && ((t = e.substring(i, e.length)), (e = e.substring(0, i))),
