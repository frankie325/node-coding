    ...
    (t.prototype.resolve = function () {
        ...
        for (var a = this, b = a.dependencies.length, c = 0; c < a._entry.length; c++) {
          for (var d = a._entry[c], e = 0, f = 0; b > f; f++) {
            ...
            g.status < ib.LOADED &&
              ...
              ((d.history[g.uri] = !0), e++, g._entry.push(d), g.status === ib.LOADING && g.pass());
          }
      ...
      (t.prototype.fetch = function (a) {
        ...
        return !h || gb.hasOwnProperty(h)
          ...
          : ((fb[h] = !0),
            (hb[h] = [e]),
            C('request', (g = { uri: f, requestUri: h, onRequest: d, charset: z(v.charset) ? v.charset(h) || 'utf-8' : v.charset })),
